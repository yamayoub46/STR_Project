...
from flaskProject2.algorithms.LLF.prime import lcm
...
if __name__ == '__main__':
    html_color = {'Task1': 'red', 'Task2': 'blue', 'Task3': 'green', 'Task4': 'aqua', 'Task5': 'coral', 'Empty': 'grey',
                  'Finish': 'black'}
    ...
    for line in lines:
        indexHtml += line
    output = open('../../outputs/llf.html', 'w')
